...
const ModuleList = ({sequence_modules, executionPanelRef, setAbortDisabled}) => {
    ...
    const listHeaders = Object.entries(sequences_modules_obj).flatMap(([moduleKey,sequences]) =>
        <SequenceModule key={moduleKey} header={moduleKey} sequences={JSON.stringify(sequences)} executionPanelRef={executionPanelRef} setAbortDisabled={setAbortDisabled}></SequenceModule>
    )
